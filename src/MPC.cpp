...
public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // Initial constraints
    // add 1 to starting idx due to cost is at 0
    ...
    // Calculate the rest of constraints based on model
    // t is from 1 due to 0 is used for initial state
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  // Set actuators upper and lower limits (25degree into radians)
